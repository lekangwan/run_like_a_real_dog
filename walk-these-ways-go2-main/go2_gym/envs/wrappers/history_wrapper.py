...
class HistoryWrapper(gym.Wrapper):
    def __init__(self, env):
        ...
        self.obs_shift_buffer = torch.zeros(
            self.env.num_envs,
            self.num_obs_history - self.num_obs,
            dtype=torch.float,
    ...
    def _update_obs_history(self, obs):
        self.obs_shift_buffer.copy_(self.obs_history[:, self.env.num_obs:])
        self.obs_history[:, :-self.env.num_obs].copy_(self.obs_shift_buffer)
        self.obs_history[:, -self.env.num_obs:].copy_(obs)
